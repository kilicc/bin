(function (global) {
  ...
  var POLL_MS =
    document.body && document.body.classList.contains("mega-desk-9006") ? 15000 : 5000;
  var BOT_PORT = "9008";
  var timer = null;
  var lastSeverity = "ok";
  ...
  async function poll() {
    try {
      ...
      if (!r.ok) {
        ...
        var hint =
          st === 502 || st === 503
            ? "nginx → bot (127.0.0.1:" + BOT_PORT + ") kapalı veya yeniden başlıyor — deploy/restart sonrası ~30sn bekleyin"
            : st === 401 || st === 403
        ...
        alerts: [
          {
            ...
            detail: msg + " — Binance API değil; yerel MEGA bot (port " + BOT_PORT + ") veya nginx proxy.",
          },
        ],
