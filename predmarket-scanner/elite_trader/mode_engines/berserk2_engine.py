"""BERSERK2 — top-10 mover + BTC-aware micro-scalp."""
from __future__ import annotations

from typing import Any

from elite_trader.mode_engines.berserk2_scoring import evaluate_berserk2_entry
...
def evaluate(signal: dict[str, Any], ctx: dict[str, Any]) -> tuple[bool, str]:
    ...
    ok, reason, meta = evaluate_berserk2_entry(
        signal,
        ctx,
        profile,
        edge=edge,
