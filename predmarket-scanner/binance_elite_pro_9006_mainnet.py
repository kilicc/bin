#!/usr/bin/env python3
"""
Binance Futures Elite Pro — port 9006 (MEGA demo-fapi canlı veya paper sim).
Panel: https://mega6.example.com → 127.0.0.1:9006
API anahtarları: scenarios/.env.mega_9006 (git dışı, chmod 600)
"""
...
_telegram = _ROOT / "scenarios" / ".env.telegram_9006"
...
# Varsayılan: demo-fapi canlı (senaryo + .env.mega_9006 ile override)
