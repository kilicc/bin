...
| Alan | Değer |
|------|-------|
| checkpoint_id | `20260605_162754__restart_boot_boot_9005` |
| created_at | `2026-06-05T16:27:54.399155+00:00` |
| event_type | `restart_boot` |
| label | Bot açılış (startup) |
| project_root | `predmarket-scanner` |
| md_path | `data/reports/checkpoints/20260605_162754__restart_boot_boot_9005.md` |
...
```json
{
  "collected_at": "2026-06-05T16:27:54.381713+00:00",
