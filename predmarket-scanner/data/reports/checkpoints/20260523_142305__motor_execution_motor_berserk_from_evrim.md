# Checkpoint — Emir motoru evrim → berserk

## CHECKPOINT_META

| Alan | Değer |
|------|-------|
| checkpoint_id | `20260523_142305__motor_execution_motor_berserk_from_evrim` |
| created_at | `2026-05-23T14:23:05.116969+00:00` |
| event_type | `motor_execution` |
| label | Emir motoru evrim → berserk |
| project_root | `predmarket-scanner` |
| md_path | `data/reports/checkpoints/20260523_142305__motor_execution_motor_berserk_from_evrim.md` |
...
### 1. Emir motoru
- `execution_mode`: `berserk` (önceki: `evrim`)
```python
from elite_trader.panel_strategy import set_execution_mode
set_execution_mode("berserk", note="restore from checkpoint")
```

### 2. panel_strategy_state.json (tam)
```json
{
  "execution_mode": "berserk",
  "active_futures_mode": "evrim",
  "view_mode": "evrim",
  "current_mode": "berserk",
  "last_execution_change_at": "2026-05-23T14:23:05.114812+00:00",
  "last_execution_note": "emir motoru evrim → berserk"
}
```
...
```json
{
  "collected_at": "2026-05-23T14:23:05.115683+00:00",
  ...
  "evrim_config_versions": {
    ...
    "candidate_config_version": "evrim_cfg_candidate_20260523_142305_46185",
    "candidate_snapshot": {
      "spread_policy": "evrim_adaptive",
      "sl_stake_pct": 0.0024,
      "evrim_v2_fee_gross_caution": 0.45,
    ...
    "candidate_meta": {
      ...
      "created_at": "2026-05-23T14:23:05.009443+00:00"
    },
    "updated_at": "2026-05-23T14:23:05.009453+00:00"
  },
  "evrim_persistent_learning": {
    ...
    "recent_cross": [
      ...
      {
        "ts": "2026-05-23T14:12:42.468652+00:00",
        "batch_key": "MYXUSDT:118636370",
        "mode_id": "sentinel",
        "symbol": "MYXUSDT",
        "side": "LONG",
