...
| Alan | Değer |
|------|-------|
| checkpoint_id | `20260523_140557__restart_boot_boot_9005` |
| created_at | `2026-05-23T14:05:57.405818+00:00` |
| event_type | `restart_boot` |
| label | Bot açılış (startup) |
| project_root | `predmarket-scanner` |
| md_path | `data/reports/checkpoints/20260523_140557__restart_boot_boot_9005.md` |
...
```json
{
  ...
  "view_mode": "evrim",
  "current_mode": "evrim",
  "last_execution_change_at": "2026-05-23T13:29:17.245251+00:00",
  "last_execution_note": "V2 clean start"
}
```
...
```json
{
  "collected_at": "2026-05-23T14:05:57.404009+00:00",
  ...
  "mode_profiles": {
    ...
    "updated_at": "2026-05-23T14:04:52.852367+00:00"
  },
  "evrim_config_versions": {
    ...
    "active_hash": "f36514eaffd4",
    "candidate_config_version": "evrim_cfg_candidate_20260523_140453_45093",
    "candidate_snapshot": {
      "spread_policy": "evrim_adaptive",
      "sl_stake_pct": 0.0024,
      "evrim_v2_fee_gross_caution": 0.45,
    ...
    "candidate_meta": {
      ...
      "created_at": "2026-05-23T14:04:53.741578+00:00"
    },
    "updated_at": "2026-05-23T14:04:53.741600+00:00"
  },
  "evrim_persistent_learning": {
    "version": 1,
    "created_at": "2026-05-23T13:45:12.846032+00:00",
    "updated_at": "2026-05-23T13:45:12.872984+00:00",
    "learning_level": 1,
    "peak_level": 1,
    "total_xp": 4,
    "stats": {
    ...
    "recent_rejects": [
      {
        "ts": "2026-05-23T13:45:12.846053+00:00",
        "symbol": "BTCUSDT",
        "side": "LONG",
        "reason": "risk_veto",
    ...
    "recent_cross": [
      {
        "ts": "2026-05-23T13:45:12.846045+00:00",
        "batch_key": "BTCUSDT:118636260",
        "mode_id": "evrim",
        "symbol": "BTCUSDT",
        "side": "LONG",
        "allowed": false,
      ...
      {
        "ts": "2026-05-23T13:45:12.869978+00:00",
        "batch_key": "BTCUSDT:118636260",
        "mode_id": "berserk",
        "symbol": "BTCUSDT",
        "side": "LONG",
    ...
    "cross_insights": {
      ...
      "strategy_notes": [
        "2026-05-23T13:45:12 Evrim red (risk_veto) — berserk açardı (BTCUSDT)"
      ]
    },
    "strategy_hints": {
    ...
    "last_report": {
      ...
      "backtest_memory": {},
      "analysis_cycles": 2,
      "updated_at": "2026-05-23T13:45:12.872117+00:00",
      "learning_blocks_trading": false,
      "trading_continues": true
    },
    "last_analysis_at": 1779543912.8704882,
