...
| Alan | Değer |
|------|-------|
| checkpoint_id | `20260523_143105__motor_execution_motor_evrim_from_evrim` |
| created_at | `2026-05-23T14:31:05.552802+00:00` |
| event_type | `motor_execution` |
| label | Emir motoru evrim → evrim |
| project_root | `predmarket-scanner` |
| md_path | `data/reports/checkpoints/20260523_143105__motor_execution_motor_evrim_from_evrim.md` |
...
```json
{
  "collected_at": "2026-05-23T14:31:05.551854+00:00",
