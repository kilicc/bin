...
| Alan | Değer |
|------|-------|
| checkpoint_id | `20260523_230108__restart_boot_boot_9005` |
| created_at | `2026-05-23T23:01:08.317581+00:00` |
| event_type | `restart_boot` |
| label | Bot açılış (startup) |
| project_root | `predmarket-scanner` |
| md_path | `data/reports/checkpoints/20260523_230108__restart_boot_boot_9005.md` |
...
```json
{
  "collected_at": "2026-05-23T23:01:08.316609+00:00",
  ...
  "evrim_persistent_learning": {
    ...
    "updated_at": "2026-05-23T23:01:07.026771+00:00",
    "learning_level": 1,
    "peak_level": 1,
    "total_xp": 10,
    "stats": {
