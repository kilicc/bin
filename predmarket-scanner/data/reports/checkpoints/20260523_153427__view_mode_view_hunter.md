...
| Alan | Değer |
|------|-------|
| checkpoint_id | `20260523_153427__view_mode_view_hunter` |
| created_at | `2026-05-23T15:34:27.956100+00:00` |
| event_type | `view_mode` |
| label | Görünüm berserk → hunter |
| project_root | `predmarket-scanner` |
| md_path | `data/reports/checkpoints/20260523_153427__view_mode_view_hunter.md` |
...
```json
{
  "collected_at": "2026-05-23T15:34:27.941203+00:00",
